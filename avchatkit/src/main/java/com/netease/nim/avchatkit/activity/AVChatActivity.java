...
public class AVChatActivity extends UI implements AVChatVideoUI.TouchZoneCallback, AVSwitchListener {
    ...
    private static String urlTemp="";

    // 拨打电话
    public static void outgoingCall(Context context, String account, String displayName, int callType, int source,Map<String,Object> maptemp,String mUrl) {
        needFinish = false;
        map = maptemp;
        urlTemp = mUrl;
...
//                AVChatSoundPlayer.instance().stop();
    ...
    private void manualHangUp(int exitCode) {
        ...
        Log.i("123456789","======="+map.toString());
        Log.i("urlTemp","===urlTemp===="+urlTemp);
    ...
    private void getDestoryAvChat(final Map<String, Object> mapTemp) {
        pfb = OkHttpUtils.post().url(urlTemp);
        pfb.params(mapTemp);
        ...
        requestCall.execute(new StringCallback() {
            ...
            public void onResponse(String response) {
                ...
                String msg = "";
                try {
                    Log.i("AVChatActivity.class", "response==" + response);
