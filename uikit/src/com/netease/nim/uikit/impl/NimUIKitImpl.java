...
import com.netease.nim.uikit.avchat.StickerAttachment;
...
public final class NimUIKitImpl {
    ...
    public static Map<String,List<IMMessage>> history;
    ...
    */
    ...
    public static void startP2PSession(String nickName,String nmcUrl, String nmcToken, String url, Map<String,Object> params, Context context, String account) {
        startP2PSession(nickName,nmcUrl,nmcToken,url,params,context, account, null);
    }
    public static void startP2PSession(String nickName,String nmcUrl,String nmcToken,String url,Map<String,Object> params,Context context, String account, IMMessage anchor) {
        NimUIKitImpl.startChatting(nickName,nmcUrl,nmcToken,url,params,context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, anchor);
    }

    public static void startChatting(String nickName,String nmcUrl,String nmcToken,String url,Map<String,Object> params,Context context, String id, SessionTypeEnum sessionType, SessionCustomization
            customization, IMMessage anchor) {
        if (sessionType == SessionTypeEnum.P2P) {
            P2PMessageActivity.start(nickName,nmcUrl,nmcToken,url,params,context, id, customization, anchor);
        }
    }
