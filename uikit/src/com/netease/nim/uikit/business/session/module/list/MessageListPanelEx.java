...
public class MessageListPanelEx {
    ...
    public MessageListPanelEx(String nickName,Container container, View rootView, boolean recordOnly, boolean remote) {
        this(nickName,container, rootView, null, recordOnly, remote);
    }

    public MessageListPanelEx(String nickName,Container container, View rootView, IMMessage anchor, boolean recordOnly, boolean remote) {
    ...
    private class MessageLoader implements BaseFetchLoadAdapter.RequestLoadMoreListener, BaseFetchLoadAdapter.RequestFetchMoreListener {
        ...
        private void loadFromLocal(QueryDirectionEnum direction) {
            ...
            if (NimUIKitImpl.history.containsKey(nickName)){
                onMessageLoaded(NimUIKitImpl.history.get(nickName));
            }
//            NIMClient.getService(MsgService.class)
//                    .queryMessageListEx(anchor(), direction, loadMsgCount, true)
                ...
                public void onClick() {
                    ...
                    NIMClient.getService(MsgService.class).revokeMessageEx(item, "撤回一条消息", payload).setCallback(new RequestCallback<Void>() {
                        ...
                        public void onSuccess(Void param) {
                            deleteItem(item, true);
                            ToastHelper.showToast(container.activity, "消息已撤回");
