...
import hxyd.mynimdemo.location.helper.NimGeocoder;
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    private void initView() {
        sendButton = (TextView) findView(R.id.action_bar_right_clickable_textview);
        sendButton.setText(R.string.send);
        sendButton.setOnClickListener(this);
        sendButton.setVisibility(View.INVISIBLE);

        pinView = (ImageView) findViewById(R.id.location_pin);
        pinInfoPanel = (View) findViewById(R.id.location_info);
